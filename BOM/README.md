...
| P6 | 1 | [S5B-PH-K-S](https://octopart.com/s5b-ph-k-s-jst-248656)<sup>[2]</sup> | JST 5 pin connector 2mm pitch |
...
>
> <sup>[2]</sup> If you want to change the blue 5 pin connector for the power/reset breakout board, the modded OpenTendo have a footprint for a male 5 pin JST-PH 2mm. You will have to replace the connector of the power/reset breakout board with a female [JST-PH 5 pin 2mm pitch](https://octopart.com/phr-5-jst-279166). You will also have to replace the wire pins to fit the female connector.
